// @generated by scripts/generate-game-rules.mjs. DO NOT EDIT.
...
export function getDifficultyMultiplier(difficulty: Difficulty): { ghostSpeed: number; maintenance: number } {
  ...
  if (difficulty === 'nightmare') {
    return { ghostSpeed: 1.5, maintenance: 2 };
  }
  return { ghostSpeed: 1, maintenance: 1 };
}

export function getCapturePressure(captureRatio: number): { graceMs: number; regenMultiplier: number } {
  if (captureRatio <= 0.3) {
    return { graceMs: 120000, regenMultiplier: 1 };
  }
  if (captureRatio <= 0.5) {
    return { graceMs: 90000, regenMultiplier: 1.3 };
  }
  if (captureRatio <= 0.7) {
    return { graceMs: 60000, regenMultiplier: 1.8 };
  }
  if (captureRatio <= 0.85) {
    return { graceMs: 40000, regenMultiplier: 2.5 };
  }
  if (captureRatio <= 0.95) {
    return { graceMs: 25000, regenMultiplier: 3.5 };
  }
  return { graceMs: 15000, regenMultiplier: 5 };
}
